...
namespace Itinero.Geo.Directions
{
    internal static class DirectionCalculator
    {
            ...
            (double longitude, double latitude, float? e) coordinate3)
        {
            ...
            if (dot > 0) { // dot > 0
                ...
                if (cross > 0) { // dot > 0 and cross > 0
                    ...
                    if (angle > Math.PI / 2f + Math.PI / 4f) { // use cosine.
                        angle = (double) Math.Acos(dot / (v1Size * v2Size));
                    }
                    ...
                    // Quadrant 3
                    angle = -(-(double) Math.PI + (double) Math.Asin(cross / (v1Size * v2Size)));
                    if (angle < Math.PI + Math.PI / 4f) { // use cosine.
                        angle = (double) (Math.PI * 2.0f) - (double) Math.Acos(dot / (v1Size * v2Size));
                    }
            ...
            (double longitude, double latitude, float? e) coordinate2)
        {
            ...
            if (angle < 22.5 || angle >= 360 - 22.5) { // north
                return DirectionEnum.North;
            }
            else if (angle >= 22.5 && angle < 90 - 22.5) { // north-east.
                return DirectionEnum.NorthWest;
            }
            else if (angle >= 90 - 22.5 && angle < 90 + 22.5) { // east.
                return DirectionEnum.West;
            }
            else if (angle >= 90 + 22.5 && angle < 180 - 22.5) { // south-east.
                return DirectionEnum.SouthWest;
            }
            else if (angle >= 180 - 22.5 && angle < 180 + 22.5) { // south
                return DirectionEnum.South;
            }
            else if (angle >= 180 + 22.5 && angle < 270 - 22.5) { // south-west.
                return DirectionEnum.SouthEast;
            }
            else if (angle >= 270 - 22.5 && angle < 270 + 22.5) { // south-west.
                return DirectionEnum.East;
            }
            else if (angle >= 270 + 22.5 && angle < 360 - 22.5) { // south-west.
