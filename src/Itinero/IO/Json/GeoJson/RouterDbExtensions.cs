...
namespace Itinero.IO.Json.GeoJson
{
    ...
    public static class RouterDbExtensions
    {
        ...
        public static void WriteVertexFeature(this Utf8JsonWriter jsonWriter, VertexId vertexId, RoutingNetwork routerDb)
        {
        ...
        public static void WriteEdgeFeature(this Utf8JsonWriter jsonWriter, IEdgeEnumerator<RoutingNetwork> enumerator)
        {
            jsonWriter.WriteFeatureStart();
