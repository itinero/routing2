...
namespace Itinero.Network.Mutation
{
    public static class RoutingNetworkMutatorExtensions
    {
        ...
        public static (double longitude, double latitude, float? e) GetVertex(this RoutingNetworkMutator routingNetwork, VertexId vertex)
        {
        ...
        public static VertexId AddVertex(this RoutingNetworkMutator routingNetwork, (double longitude, double latitude, float? e) location)
        {
