...
namespace Itinero.Profiles.Lua.Interop
{
	...
	internal class PropertyTableAssigner<T> : IPropertyTableAssigner
	{
	...
	/// </summary>
	internal class PropertyTableAssigner : IPropertyTableAssigner
	{
		Type m_Type;
	...
	/// </summary>
	internal interface IPropertyTableAssigner
	{
		/// <summary>
		/// Assigns the properties of the specified object without checking the type.
		/// </summary>
