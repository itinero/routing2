...
namespace Itinero.Data.Graphs
{
    public class Graph
    {
        ...
        // contains coordinates per vertex.
        private readonly ArrayBase<double> _coordinates;

        // pointers to the edges.
        private readonly ArrayBase<uint> _vertexPointers;
        ...
        public ulong AddVertex(double longitude, double latitude)
        {
            ...
            { // tile is at max capacity, double the capacity and add to the end.
                ...
                for (var v = 0; v < tileCapacity; v++)
                {
                    ...
                    _vertexPointers[newPointer] = _vertexPointers[pointer];
                }
                _tiles[tileIndexPointer + TilePointerOffset] = _nextTilePointer;
            ...
            _vertexPointers[nextVertexPointer] = GraphConstants.NoEdges;
            tileSize++;
