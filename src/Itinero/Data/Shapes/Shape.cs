...
namespace Itinero.Data.Shapes
{
    ...
    public class Shape : ShapeBase
    {
        ...
        /// Creates a new shape.
        /// </summary>
        internal Shape(ArrayBase<double> coordinates, long pointer, int size)
        {
        ...
        /// Creates a new shape.
        /// </summary>
        internal Shape(ArrayBase<double> coordinates, ArrayBase<short> elevation, long pointer, int size, bool reversed)
        {
            _coordinates = coordinates;
            _elevation = elevation;
            _pointer = pointer;
