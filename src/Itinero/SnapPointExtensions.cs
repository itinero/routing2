...
namespace Itinero
{
    ...
    public static class SnapPointExtensions
    {
        ...
        public static Result<SnapPoint> Snap(this Network routerDb, (double longitude, double latitude) location,
            Profile profile)
        {
        ...
        public static Result<SnapPoint> Snap(this Network routerDb, VertexId vertexId, EdgeId? edgeId = null)
        {
        ...
        public static Result<IEnumerable<SnapPoint>> SnapAll(this Network routerDb,
        ...
        public static (double longitude, double latitude) LocationOnNetwork(this SnapPoint snapPoint, Network routerDb)
        {
            var enumerator = routerDb.GetEdgeEnumerator();
        ...
        public static bool? Direction(this SnapPoint snapPoint, Network routerDb, DirectionEnum direction,
        ...
        /// <returns>The direction on the edge at the location of the snap point that best matches the given direction.
        /// Returns null if the difference is too big relative to the tolerance or the edge is too small to properly calculate an angle.</returns>
        public static bool? DirectionFromAngle(this SnapPoint snapPoint, Network routerDb, double degreesMeridian, out double difference, double distance = 10,
            double tolerance = 90)
        {
        ...
        public static double? Angle(this SnapPoint snapPoint, Network routerDb, double distance = 10)
        {
