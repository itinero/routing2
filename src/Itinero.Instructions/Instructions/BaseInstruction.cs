namespace Itinero.Instructions.Instructions
{
    ...
    /// - 'Take the Nth exit of the roundabout, this is ~straight on' (note that this instruction possibly spans multiple segments of the roundabout)
    ///
    /// A client which outputs actual text for humans, might even need a little bit more of lookahead in the instructions, in order to generate stuff as:
    ...
    ///
    ///
    /// Subclasses of Instruction might add additional information, such as 'cross XYZ at the end', 'you are currently travelling a roundabout', ...
    ///
    ///
    ...
    public class BaseInstruction
    {
        ...
        /// <remarks>Will often (but not always) be ShapeIndex + 1. The start- and endinstruction have ShapeIndexEnd == ShapeIndex; some others describe multiple segments</remarks>
        /// </summary>
