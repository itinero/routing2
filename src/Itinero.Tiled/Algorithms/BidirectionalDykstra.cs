...
namespace Itinero.Tiled.Algorithms
{
        ...
        where T : struct
    {
        ...
        private ulong _bestVertex = uint.MaxValue;
        ...
        /// </summary>
        /// <returns></returns>
        private bool ReachedVertexForward(ulong vertex, T weight)
        {
            // check backward search for the same vertex.
            TiledEdgePath<T> backwardVisit;
        ...
        /// </summary>
        /// <returns></returns>
        private bool ReachedVertexBackward(ulong vertex, T weight)
        {
            // check forward search for the same vertex.
            TiledEdgePath<T> forwardVisit;
        ...
        /// </summary>
        /// <returns></returns>
        public TiledEdgePath<T> GetPath()
        {
            this.CheckHasRunAndHasSucceeded();

            TiledEdgePath<T> fromSource;
            TiledEdgePath<T> toTarget;
