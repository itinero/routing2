...
namespace Itinero.Tests
{
    ...
    {
        public static IEqualityComparer<(double longitude, double latitude, float? e)> GetCoordinateComparer(int tolerance = 4) =>
    ...
    internal class CoordinateComparer : IEqualityComparer<(double longitude, double latitude, float? e)>
    {
        ...
        public bool Equals((double longitude, double latitude, float? e) x, (double longitude, double latitude, float? e) y)
        {
