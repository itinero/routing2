...
namespace Itinero.Tests.Network.Tiles
{
    public class TileStaticTests
    {
        ...
        {
            var tiles = ((5.959307791040118, 49.94263396894212, (float?)null), (5.987251161291425, 49.94263396894212, (float?)null)).TileRange(14);
        ...
        {
            var tiles = ((5.959307791040118, 49.94263396894212, (float?)null), (5.959307791040118, 49.92464753682374, (float?)null)).TileRange(14);
        ...
        {
            var tiles = ((5.959307791040118, 49.94263396894212, (float?)null), (5.987251161291425, 49.92464753682374, (float?)null)).TileRange(14);
