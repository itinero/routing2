    ...
    public class IEdgeEnumeratorExtensionsTests
    {
        ...
        public void IEdgeEnumeratorExtensions_GetCompleteShape_NoShape_Forward_ShouldReturnVertices()
        {
            var (routerDb, vertices, edges) = RouterDbScaffolding.BuildRouterDb(
                ...
                {
                    (0, 1, System.Array.Empty<(double longitude, double latitude)>())
                });
            ...
            ItineroAsserts.SameLocations((4.801073670387268, 51.268064181900094), shape[0]);
            ItineroAsserts.SameLocations((4.801771044731140, 51.268886491558250), shape[1]);
        }
        [Fact]
        public void IEdgeEnumeratorExtensions_GetCompleteShape_NoShape_Backward_ShouldReturnVertices()
        {
            ...
            var shape = enumerator.GetCompleteShape().ToArray();
            Assert.Equal(2, shape.Length);
            ItineroAsserts.SameLocations((4.801771044731140, 51.268886491558250), shape[0]);
            ItineroAsserts.SameLocations((4.801073670387268, 51.268064181900094), shape[1]);
        }
        ...
        public void IEdgeEnumeratorExtensions_GetCompleteShape_WithShape_Forward_ShouldReturnVerticesAndShape()
        {
            ...
            ItineroAsserts.SameLocations((4.801242649555205, 51.268816008449830), shape[2]);
            ItineroAsserts.SameLocations((4.801771044731140, 51.268886491558250), shape[3]);
        }
        ...
        public void IEdgeEnumeratorExtensions_GetCompleteShape_WithShape_Backward_ShouldReturnVerticesAndShape()
        {
            ...
            ItineroAsserts.SameLocations((4.800950288772583, 51.268426671236426), shape[2]);
            ItineroAsserts.SameLocations((4.801073670387268, 51.268064181900094), shape[3]);
        }
    }
}