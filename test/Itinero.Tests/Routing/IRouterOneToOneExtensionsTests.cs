...
namespace Itinero.Tests.Routing
{
    public class IRouterOneToOneExtensionsTests
    {
        ...
        public void IRouterOneToOneExtensions_Calculate_OneEdge_ShouldMatchEdge()
        {
            ...
            Assert.True((4.801771044731140, 51.268886491558250, (float?)null).DistanceEstimateInMeter(route.Shape[0]) < 1);
            Assert.True((4.801073670387268, 51.268064181900094, (float?)null).DistanceEstimateInMeter(route.Shape[1]) < 1);
        }
        ...
        public void IRouterOneToOneExtensions_Calculate_OneEdge_Reverse_ShouldMatchEdge()
        {
            ...
            Assert.NotNull(route.Shape);
            Assert.Equal(2, route.Shape.Count);
            Assert.True((4.801073670387268, 51.268064181900094, (float?)null).DistanceEstimateInMeter(route.Shape[0]) < 1);
            Assert.True((4.801771044731140, 51.268886491558250, (float?)null).DistanceEstimateInMeter(route.Shape[1]) < 1);
        }
        ...
        public void IRouterOneToOneExtensions_Calculate_OneEdge_WithShapePoint_ShouldMatchEdge()
        {
            ...
            Assert.True((4.801771044731140, 51.268886491558250, (float?)null).DistanceEstimateInMeter(route.Shape[0]) < 1);
            Assert.True((4.800735712051392, 51.268722030803770, (float?)null).DistanceEstimateInMeter(route.Shape[1]) < 1);
            Assert.True((4.801073670387268, 51.268064181900094, (float?)null).DistanceEstimateInMeter(route.Shape[2]) < 1);
        }
        ...
        public void IRouterOneToOneExtensions_Calculate_OneEdge_Reverse_WithShapePoint_ShouldMatchEdge()
        {
            ...
            Assert.True((4.801073670387268, 51.268064181900094, (float?)null).DistanceEstimateInMeter(route.Shape[0]) < 1);
            Assert.True((4.800735712051392, 51.268722030803770, (float?)null).DistanceEstimateInMeter(route.Shape[1]) < 1);
            Assert.True((4.801771044731140, 51.268886491558250, (float?)null).DistanceEstimateInMeter(route.Shape[2]) < 1);
        }
        ...
        public void IRouterOneToOneExtensions_Calculate_OneEdge_With2ShapePoints_ShouldMatchEdge()
        {
            ...
            Assert.True((4.801771044731140, 51.268886491558250, (float?)null).DistanceEstimateInMeter(route.Shape[0]) < 1);
            Assert.True((4.801242649555205, 51.268816008449830, (float?)null).DistanceEstimateInMeter(route.Shape[1]) < 1);
            Assert.True((4.800950288772583, 51.268426671236426, (float?)null).DistanceEstimateInMeter(route.Shape[2]) < 1);
            Assert.True((4.801073670387268, 51.268064181900094, (float?)null).DistanceEstimateInMeter(route.Shape[3]) < 1);
        }
        ...
        public void IRouterOneToOneExtensions_Calculate_OneEdge_Reverse_With2ShapePoints_ShouldMatchEdge()
        {
            ...
            Assert.Equal(4, route.Shape.Count);
            Assert.True((4.801073670387268, 51.268064181900094, (float?)null).DistanceEstimateInMeter(route.Shape[0]) < 1);
            Assert.True((4.800950288772583, 51.268426671236426, (float?)null).DistanceEstimateInMeter(route.Shape[1]) < 1);
            Assert.True((4.801242649555205, 51.268816008449830, (float?)null).DistanceEstimateInMeter(route.Shape[2]) < 1);
            Assert.True((4.801771044731140, 51.268886491558250, (float?)null).DistanceEstimateInMeter(route.Shape[3]) < 1);
        }
        ...
        public void IRouterOneToOneExtensions_Calculate_TwoEdge_With2ShapePoints_ShouldMatchEdges()
        {
            ...
            Assert.True((4.801242649555205, 51.268816008449830, (float?)null).DistanceEstimateInMeter(route.Shape[2]) < 1);
            Assert.True((4.801771044731140, 51.268886491558250, (float?)null).DistanceEstimateInMeter(route.Shape[3]) < 1);
            Assert.True((4.802066087722777, 51.268582742153434, (float?)null).DistanceEstimateInMeter(route.Shape[4]) < 1);
            Assert.True((4.801921248435973, 51.268258852454680, (float?)null).DistanceEstimateInMeter(route.Shape[5]) < 1);
            Assert.True((4.802438914775848, 51.268097745847650, (float?)null).DistanceEstimateInMeter(route.Shape[6]) < 1);
        }
    }
}